  ...
  return (
    <div>
      <div className={style.description_container}>
        <h5>About me: </h5><span>{profile.aboutMe}</span>
      </div>
      <div className={style.description_container}>
        <h5>Looking for a job: </h5><span>{profile.lookingForAJob ? 'yes' : 'no'}</span>
      </div>
      <div className={style.description_container}>
        <h5>Looking for a job description: </h5><span>{profile.lookingForAJobDescription}</span>
      </div>
      <div>
        <h5>Contacts</h5>
