    ...
    <>
      <form onSubmit={props.handleSubmit}>
        <div className={style.description_container}>
          <h5>About me: </h5>
          <Field placeholder={'About me'} name={'aboutMe'} component={Input} validate={[]} />
        </div>
        ...
        <div>
          ...
          <div className={style.contacts_container}>
            ...
            <div className={style.description_container}>
              <h6>Vk: </h6>
              <Field placeholder={'vk'} name={'contacts.vk'} component={Input} validate={[]} />
            </div>
...
export const ProfileUserAboutDataEditForm = reduxForm<ProfileDataEditFormType>({
  form: 'profile-contacts',
})(ProfileUserAboutDataEdit)
